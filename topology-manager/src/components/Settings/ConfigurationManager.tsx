      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Loading configuration data...</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {deviceConfigs.map((config) => {
                  ...
                  return (
                    <div key={config.deviceId} className="bg-white dark:bg-gray-800 rounded-lg p-4">
          ...
          {selectedView === 'policies' && (
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {policies.map((policy) => (
                  <div key={policy.id} className="bg-white dark:bg-gray-800 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      {policy.rules.map((rule, index) => (
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                          <div>
                            <div className="font-medium text-gray-900 dark:text-white">{rule.message}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">

        ...
        return (
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              />
              <label htmlFor="enableExpansion" className="text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <div className="space-y-4">
              <h4 className="text-md font-medium text-gray-900 dark:text-white">Include Device Types</h4>
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <input
                ...
                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
              />
              <label htmlFor="useAllCurrent" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                Use all current credentials
              </label>
            </div>
            
            <div className="space-y-4">
              <h4 className="text-md font-medium text-gray-900 dark:text-white">Available Credentials</h4>
              <div className="space-y-2">
                {mockCredentials.map((credential) => (
                  <div key={credential.id} className="flex items-center justify-between p-3 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div className="flex items-center space-x-3">
                      <input
                        type="checkbox"
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
              />
              <label htmlFor="autoMonitoring" className="text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
            <div className="flex justify-between">
              <button
                ...
                className="px-4 py-2 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Previous
              </button>

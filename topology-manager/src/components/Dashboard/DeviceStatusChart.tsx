...
const DeviceStatusChart: React.FC<DeviceStatusChartProps> = ({ data }) => {
  ...
  const statusItems = [
    { label: 'Up', count: data.up, percentage: percentages.up, color: 'bg-green-500' },
    { label: 'Down', count: data.down, percentage: percentages.down, color: 'bg-red-500' },
    { label: 'Warning', count: data.warning, percentage: percentages.warning, color: 'bg-yellow-500' },
    { label: 'Unknown', count: data.unknown, percentage: percentages.unknown, color: 'bg-gray-500' }
  ];

...
const EnhancedNetworkMap: React.FC<EnhancedNetworkMapProps> = ({ onDeviceSelect, onSiteSelect }) => {
  ...
  return (
    <div className="flex h-full bg-white dark:bg-gray-900 rounded-lg shadow-md overflow-hidden">
      {/* Left Sidebar for Controls */}
      <div className="w-80 bg-gray-50 dark:bg-gray-800 p-4 border-r border-gray-200 dark:border-gray-700 overflow-y-auto">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Network Map Controls</h3>
        
        {/* Layout Controls */}
        <div className="mb-6">
          <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Layout</h4>
          <select
            value={layoutType}
        ...
        {/* Display Options */}
        <div className="mb-6">
          <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Display Options</h4>
          <div className="space-y-2">
            <label className="inline-flex items-center">
              ...
              />
              <span className="ml-2 text-gray-700 dark:text-gray-300">Device Names</span>
            </label>
            <label className="inline-flex items-center">
              <input
                type="checkbox"
              ...
              />
              <span className="ml-2 text-gray-700 dark:text-gray-300">IP Addresses</span>
            </label>
            <label className="inline-flex items-center">
              <input
                type="checkbox"
              ...
              />
              <span className="ml-2 text-gray-700 dark:text-gray-300">Network Links</span>
            </label>
          </div>
        </div>
        ...
        {/* Overlay Options */}
        <div className="mb-6">
          <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Overlays</h4>
          <div className="space-y-2">
            <label className="inline-flex items-center">
              <input
                type="checkbox"
              ...
              />
              <span className="ml-2 text-gray-700 dark:text-gray-300">VLAN Overlay</span>
            </label>
            <label className="inline-flex items-center">
              <input
                type="checkbox"
              ...
              />
              <span className="ml-2 text-gray-700 dark:text-gray-300">Security Zones</span>
            </label>
            <label className="inline-flex items-center">
              <input
                type="checkbox"
              ...
              />
              <span className="ml-2 text-gray-700 dark:text-gray-300">Dependencies</span>
            </label>
          </div>
        </div>
        ...
        {/* Zoom Controls */}
        <div className="mb-6">
          <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">View Controls</h4>
        ...
        {/* Status Legend */}
        <div className="mb-6">
          <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Status Legend</h4>
        ...
        {selectedDevice && (
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Selected Device</h4>
            ...
            {mockDevices.map((device, index) => {
              ...
              return (
                ...
                >
                  ...
                  <circle
                    r="20"
                    className={`${getDeviceColor(device.status)} stroke-2 ${isSelected ? 'stroke-blue-400' : 'stroke-gray-300 dark:stroke-gray-600'}`}
                  />
      ...
      {selectedDevice && (
        <div className="w-80 bg-gray-50 dark:bg-gray-800 p-4 border-l border-gray-200 dark:border-gray-700 overflow-y-auto">
          ...
          <div className="space-y-4">
            {/* Basic Info */}
            <div>
              <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Basic Information</h4>
            ...
            {/* Roles */}
            <div>
              <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Roles</h4>
            ...
            {/* Interfaces */}
            <div>
              <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Interfaces ({selectedDevice.interfaces.length})</h4>
            ...
            {selectedDevice.dependencies.length > 0 && (
              <div>
                <h4 className="text-md font-medium text-gray-900 dark:text-white mb-2">Dependencies</h4>
                <div className="space-y-1">

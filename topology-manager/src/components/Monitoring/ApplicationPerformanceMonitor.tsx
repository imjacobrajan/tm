      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Loading application data...</p>
          </div>
        </div>
      )}
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {applicationStatuses.map((app) => (
                  <div key={app.id} className="bg-white dark:bg-gray-800 rounded-lg p-4">
                  ...
                  <div key={app.id} className="bg-white dark:bg-gray-800 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                      {app.checks.map((check) => (
                        <div key={check.id} className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                          <div className="flex items-center">

      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Loading wireless data...</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
          ...
          {selectedView === 'access-points' && (
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {accessPoints.map((ap) => (
                  <div key={ap.id} className="bg-white dark:bg-gray-800 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <div>
                          <div className="font-medium text-gray-900 dark:text-white">{ap.name}</div>
                          <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {selectedView === 'clients' && (
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {clients.map((client) => (
                  <div key={client.id} className="bg-white dark:bg-gray-800 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-4">
                {accessPoints.filter(ap => ap.status === 'warning').map((ap) => (
                  <div key={ap.id} className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <div className="w-3 h-3 bg-red-500 rounded-full mr-3" />
                        <div>
                          <div className="font-medium text-red-900 dark:text-red-100">{ap.name}</div>

      ...
      {(selectedView === 'logs' || selectedView === 'search') && (
        <div className="flex space-x-4 mb-6">
          ...
          <input
            ...
            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white flex-1"
          />
        </div>
      )}
      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Loading log data...</p>
          </div>
        </div>
      )}

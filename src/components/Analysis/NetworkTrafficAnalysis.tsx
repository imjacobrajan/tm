      ...
      {isLoading && (
        <div className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Analyzing traffic data...</p>
          </div>
        </div>
      )}
        ...
        <div className="space-y-6">
                ...
                {trafficStats.topTalkers.map((talker, index) => (
                  <div key={talker.ip} className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white">{talker.ip}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                ...
                {trafficStats.topProtocols.map((protocol, index) => (
                  <div key={protocol.protocol} className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-gray-900 dark:text-white">{protocol.protocol}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {selectedView === 'bandwidth' && (
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded p-4 h-64 flex items-end justify-between">
